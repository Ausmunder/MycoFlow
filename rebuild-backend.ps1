# Rebuild Sopp Tracker Backend Container
# Run this from PowerShell on the machine where K:\ is mounted from HA

Write-Host "🍄 Rebuilding Sopp Tracker Backend..." -ForegroundColor Green
Write-Host ""

Set-Location "K:\sopp-tracker"
...
Write-Host "1. Open Sopp Tracker frontend" -ForegroundColor White
...
Write-Host ""
Write-Host "View live logs: docker-compose logs -f sopp-tracker" -ForegroundColor Yellow
